import { SeriesHeaderInfoComponentProps } from "@/types";

export const SeriesHeaderInfoComponent = ({
  selectedSeries,
}: SeriesHeaderInfoComponentProps) => {
  return (
    <div className="relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-linear-to-t from-black/90 to-transparent flex flex-row justify-between items-center">
        <div className="flex flex-row gap-4 ml-4 absolute bottom-4 left-4">
          ...
          <button className=" border-1 border-white rounded-full p-2 hover:scale-105 transition-all duration-300 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
