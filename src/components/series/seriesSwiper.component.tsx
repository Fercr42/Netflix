...
import { SeriesSwiperComponentProps } from "@/types";

export const SeriesSwiperComponent = ({
  title,
  series,
  className = "",
}: SeriesSwiperComponentProps) => {
  ...
  return (
    <div className={`mb-2 ${className}`}>
      ...
      <Swiper
        ...
        spaceBetween={0}
        slidesPerView="auto"
        navigation={typeof window !== "undefined" && window.innerWidth > 768 ? true : false}
