import { MovieOverViewComponentProps } from "@/types";

export const MovieOverViewComponent = ({
  movieDetails,
  selectedMovie,
  filter,
  onChangeFilter,
}: MovieOverViewComponentProps) => {
  return (
    <div className=" relative w-full lg:flex  lg:flex-row p-2">
      ...
      <div className="flex flex-col w-full gap-2">
        <div className="relative group">
          ...
          {filter.length > 0 && (
            <button
              onClick={() => onChangeFilter({ target: { value: "" } } as React.ChangeEvent<HTMLInputElement>)}
